	...
	public static function get($name)
	{
		...
		switch ($rec->type)
		{
			...
			default:
				...
				// F.Pozdnyakov: А чем дефолт  стрингом то не устраивает? Ну не указали тип и что теперь 
				// эксцепшном все вешать и потом искать что какой то крендель забыл указать тип в реестре?
