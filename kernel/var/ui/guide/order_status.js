ui.guide.order_status = function(config){
	var frmW = 300;
	var frmH = 200;
	Ext.apply(this, config);
	var proxy = new Ext.data.HttpProxy({
		api: {
			read: 'di/guide_order_status/list.js',
			create: 'di/guide_order_status/set.js',
			update: 'di/guide_order_status/set.js',
			destroy: 'di/guide_order_status/unset.js'
		}
	});
	...
	var Add = function(){
		var f = new ui.guide.order_status_form();
	...
	ui.guide.order_status.superclass.constructor.call(this,{
		store: store,
		columns: columns,
		loadMask: true,
		...
		tbar: [
			...
			'->', {iconCls: 'help', handler: function(){showHelp('guide-order_status')}}
		],
...
Ext.extend(ui.guide.order_status, Ext.grid.GridPanel, {
	limit: 20,
