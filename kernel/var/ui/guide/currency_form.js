ui.guide.currency_form = function(config){
	Ext.apply(this, config);
	this.Load = function(id){
		var f = this.getForm();
		f.load({
			url: 'di/guide_currency/get.json',
			params: {_sid: id},
	...
	ui.guide.currency_form.superclass.constructor.call(this, {
		frame: true, 
		defaults: {xtype: 'textfield', width: 100, anchor: '100%'},
		items: [
			{name: '_sid', xtype: 'hidden'},
			{fieldLabel: this.labelName, name: 'name', allowBlank: false, blankText: this.blankText, maxLength: 4, maxLengthText: this.maxLengthText},
...
Ext.extend(ui.guide.currency_form , Ext.form.FormPanel, {
	labelName: 'Валюта',
