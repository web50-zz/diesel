ui.guide.group_form = function(config){
	Ext.apply(this, config);
	this.Load = function(id){
		var f = this.getForm();
		f.load({
			url: 'di/guide_group/get.json',
			params: {_sid: id},
	...
	ui.guide.group_form.superclass.constructor.call(this, {
		frame: true, 
...
Ext.extend(ui.guide.group_form , Ext.form.FormPanel, {
	labelName: 'Имя',
	labelDescr: 'Описание',
