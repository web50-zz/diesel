ui.guide.type_form = function(config){
	Ext.apply(this, config);
	this.Load = function(id){
		var f = this.getForm();
		f.load({
			url: 'di/guide_type/get.json',
			params: {_sid: id},
	...
	ui.guide.type_form.superclass.constructor.call(this, {
		frame: true, 
...
Ext.extend(ui.guide.type_form , Ext.form.FormPanel, {
	labelName: 'Имя',
	labelDescr: 'Описание',
