ui.guide.pay_type_form = function(config){
	Ext.apply(this, config);
	this.Load = function(id){
		var f = this.getForm();
		f.load({
			url: 'di/guide_pay_type/get.json',
			params: {_sid: id},
	...
	ui.guide.pay_type_form.superclass.constructor.call(this, {
		frame: true, 
...
Ext.extend(ui.guide.pay_type_form , Ext.form.FormPanel, {
