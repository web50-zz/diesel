ui.guide.order_status_form = function(config){
	Ext.apply(this, config);
	this.Load = function(id){
		var f = this.getForm();
		f.load({
			url: 'di/guide_order_status/get.json',
			params: {_sid: id},
	...
	var Save = function(){
		...
		if (f.isValid()){
			f.submit({
				url: 'di/guide_order_status/set.do',
	...
	ui.guide.order_status_form.superclass.constructor.call(this, {
		frame: true, 
		defaults: {xtype: 'textfield', width: 100, anchor: '100%'},
		items: [
			{name: '_sid', xtype: 'hidden'},
			{fieldLabel: this.labelTitle, name: 'title', allowBlank: false, blankText: this.blankText, maxLength: 255, maxLengthText: this.maxLengthText},
...
Ext.extend(ui.guide.order_status_form , Ext.form.FormPanel, {
	...
	maxLengthText: 'Не больше 255 символов',
