ui.guide.style_form = function(config){
	Ext.apply(this, config);
	this.Load = function(id){
		var f = this.getForm();
		f.load({
			url: 'di/guide_style/get.json',
			params: {_sid: id},
	...
	ui.guide.style_form.superclass.constructor.call(this, {
		frame: true, 
...
Ext.extend(ui.guide.style_form , Ext.form.FormPanel, {
	labelName: 'Имя',
	labelDescr: 'Описание',
