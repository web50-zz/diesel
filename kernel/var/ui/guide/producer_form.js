ui.guide.producer_form = function(config){
	Ext.apply(this, config);
	this.Load = function(id){
		var f = this.getForm();
		f.load({
			url: 'di/guide_producer/get.json',
			params: {_sid: id},
	...
	ui.guide.producer_form.superclass.constructor.call(this, {
		frame: true, 
...
Ext.extend(ui.guide.producer_form , Ext.form.FormPanel, {
	labelName: 'Имя',
	labelDescr: 'Описание',
