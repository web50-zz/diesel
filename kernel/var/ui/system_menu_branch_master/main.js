ui.system_menu_branch_master.main = Ext.extend(ui.system_menu_branch_master.grid, {
	bttAdd: 'Импорт',
	...
	bttCancle: 'Сбросить',
	bttExport:'Экпорт',
	bttAttach: 'Добавить потомков в корень',
	bttAttachDown: 'Добавить в корень как отдельную папку',
	limit: 50,
	...
	constructor: function(config)
	{
		...
		ui.system_menu_branch_master.main.superclass.constructor.call(this, config);
		this.on({
	...
	rowCmenu:function(grid, rowIndex, e){
				...
				var cmenu = new Ext.menu.Menu({items: [
					...
					{iconCls: 'cog_add', text: this.bttAttach , handler: this.attachToRoot, scope: this},
					{iconCls: 'cog_add', text: this.bttAttachDown , handler: this.attachToRootDown, scope: this},
