ui.system_menu_branch_master.item_form = Ext.extend(Ext.form.FormPanel, {
	...
	Load: function(input){
		...
		f.load({
			url: 'di/system_menu_branch_master/get.json',
			params:params ,
	...
	setPid: function(pid){
		var f = this.getForm();
		f.setValues([{id: 'pid', value: pid}]);
	},
	Save: function(){
		var f = this.getForm();
		if (f.isValid()){
			f.submit({
				url: 'di/system_menu_branch_master/set.do',
	...
	constructor: function(config){
		...
		ui.system_menu_branch_master.item_form.superclass.constructor.call(this, config);
		if(this.pid > 0){
