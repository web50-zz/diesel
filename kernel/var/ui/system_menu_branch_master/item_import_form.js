ui.system_menu_branch_master.item_import_form = Ext.extend(Ext.form.FormPanel, {
	...
	constructor: function(config){
		...
		ui.system_menu_branch_master.item_import_form.superclass.constructor.call(this, config);
		if(this.pid > 0){
