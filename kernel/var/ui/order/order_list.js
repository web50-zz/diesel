ui.order.order_list = function(config){
	var frmW = 640;
	var frmH = 480;
	...
	var columns = [
		...
		{id: 'str_user_name', dataIndex: 'str_user_name', header: 'Пользователь', width: 200, sortable: true},
		{id: 'status_str', dataIndex: 'status_str', header: 'Статус', width: 150, sortable: true},
		{id: 'pt_string', dataIndex: 'pt_string', header: 'Способ оплаты', width: 150, sortable: true},
	...
	ui.order.order_list.superclass.constructor.call(this,{
		store: store,
		columns: columns,
		loadMask: true,
		tbar: [
...
Ext.extend(ui.order.order_list, Ext.grid.GridPanel, {
	limit: 20,
