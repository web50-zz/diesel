ui.faq.main = function(config){
	...
	var reader = new Ext.data.JsonReader({
		...
		[{name: 'id', type: 'int'}, 'faq_question_author_name']
	);
	// Typical JsonWriter
	...
	var columns = [
		...
		{id: 'faq_question_author_name', dataIndex:'faq_question_author_name', header:  this.labelName}
	];
	var Add = function(){
	...
	ui.faq.main.superclass.constructor.call(this,{
		...
		columns: columns,
		loadMask: true,
		autoExpandColumn: 'faq_question_author_name',
		tbar: [
...
Ext.extend(ui.faq.main, Ext.grid.GridPanel, {
	limit: 20,
