ui.market_clients.market_client_orders = function(config){
	...
	ui.market_clients.market_client_orders.superclass.constructor.call(this, {
		store: store,
		columns: columns,
...
Ext.extend(ui.market_clients.market_client_orders, Ext.grid.GridPanel, {
	limit: 20,
