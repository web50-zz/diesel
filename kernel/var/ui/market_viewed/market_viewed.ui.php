<?php
/**
*	ПИ "Магазин просмотренное"
*
* @author	9* 9@u9.ru  based on cart by Anthon S. Litvinenko <a.litvinenko@web50.ru>
* @package	SBIN Diesel
*/
class ui_market_viewed extends user_interface
{
	public $title = 'Магазин просмотренное';
	...
	/**
	*	Получить просмотренное  в виде HTML
	*/
	...
	*/
	...
	/**
	*	Получить  просмотренное с описанием и HTML
	*/
	...
	/**
	*	Добавить элемент в просмотренное
	*/
	protected function pub_add()
	{
		$id = request::get('id');
		$di = data_interface::get_instance('market_viewed');
		$di->_set($id);
		response::send(array(
			'success' => true,
			'count' => $di->_get($id)
