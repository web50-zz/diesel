ui.market_types.tree = function(config){
	var frmW = 400;
	var frmH = 250;
	this.pid = 0;
	this.loader = new Ext.tree.TreeLoader({url: 'di/market_types/slice.json'});
	...
	var Add = function(pid){
		var f = new ui.market_types.node_form();
	...
	ui.market_types.tree.superclass.constructor.call(this,{
		enableDD: true,
		tbar: [
...
Ext.extend(ui.market_types.tree, Ext.tree.TreePanel, {
	bttAdd: "Добавить",
	bttEdit: "Изменить",
	bttDelete: "Удалить",
