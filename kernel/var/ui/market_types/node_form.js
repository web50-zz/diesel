ui.market_types.node_form = function(config){
	Ext.apply(this, config);
	this.Load = function(id, pid){
		var f = this.getForm();
		f.load({
			url: 'di/market_types/get.json',
	...
	ui.market_types.node_form.superclass.constructor.call(this,{
		frame: true, 
		labelWidth: 120,
		...
		items: [
			...
			{fieldLabel: 'Только раздел', hiddenName: 'only_node', value: 0, xtype: 'combo', width: 50, anchor: null,
				store: new Ext.data.SimpleStore({ fields: ['value', 'title'], data: [[0, 'Да'], [1, 'Нет']] }),
				valueField: 'value', displayField: 'title',
				mode: 'local', triggerAction: 'all', selectOnFocus: true, editable: false
			},
...
Ext.extend(ui.market_types.node_form, Ext.form.FormPanel, {
